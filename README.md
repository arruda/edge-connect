...
### Running for Gnosis Adaptive Publisher specialised model:
Run as:
```
python test.py  --checkpoints ./checkpoints/places2 --input ../Datasets/Subsets/HS-D-B-1-10S --mask ../semantic-image-segmentation/outputs/masks/HS-D-B-1-10S/car --output ./checkpoints/results
```
